            ...
            VStack {
                ...
                Button(action: {
                    ...
                    HStack {
                        ...
                        Label("", systemImage: "arrow.right").foregroundColor(.white).font(.title).bold().padding(.leading)
                    }.frame(minWidth: 200, maxWidth: 400, minHeight: 50, maxHeight: 65, alignment: .center).background(Color.black).cornerRadius(8, antialiased: true).shadow(radius: 4)
